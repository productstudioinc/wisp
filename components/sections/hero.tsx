    ...
    <Section id="hero" className="min-h-[100vh] w-full overflow-hidden">
      <main className="mx-auto pt-16 sm:pt-24 md:pt-32 text-center relative px-4">
        <div className="relative">
          ...
          >
            <div className="bg-primary text-white text-xl font-bold p-1 h-20 w-20 flex items-center justify-center rounded-3xl mx-auto shadow-md">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            className="max-w-4xl mx-auto text-xl mb-8 font-medium text-balance"
          >
            From ideas to apps in seconds.
          </motion.p>
